...
#    dekliniere_substantiv("NOUN_CLOAK_OF_DISPLACEMENT", "Umhang", "es", "Umhäng", "e", "maskulin", "s", "der Verlagerung"), # Deplatzierung, Dislokation, Verdrängung, Verschiebung, Verrückung, Versatz, Verlagerung, Verwerfung, Verzerrung, 
    ...
    [unregelmaessiges_wort("NOUN_HALLU_UNIQUE_CHILI_DAS_SCHAF", "Chili das Schaf", [$nom, $akk], $mal, $sg)],
    [unregelmaessiges_wort("NOUN_HALLU_UNIQUE_CHILI_DAS_SCHAF", "Chili des Schafs", $gen, $mal, $sg)],
    [unregelmaessiges_wort("NOUN_HALLU_UNIQUE_CHILI_DAS_SCHAF", "Chili dem Schaf", $dat, $mal, $sg)],
