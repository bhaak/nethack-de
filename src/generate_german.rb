...
# sonstige Verben
		...
		Verb.verb("VERB_ANKAEMPFEN","kämpfen","an"),
		Verb.verb("VERB_ANLAECHELN", "lächeln", "an"),
		...
		Verb.verb("VERB_AUFSCHLIESSEN", "schließen", "auf"),
		...
		Verb.verb("VERB_BETAEUBEN","betäuben"),
		...
		Verb.verb("VERB_DRUECKEN","drücken"),
		...
		Verb.verb("VERB_ERWUERGEN","erwürgen"),
		...
		Verb.verb("VERB_LOSREISSEN","reißen","los"),
		...
		Verb.verb("VERB_PFLUEGEN","pflügen"),
		...
		Verb.verb("VERB_SCHLUEPFEN","schlüpfen"),
		...
		Verb.verb("VERB_SCHNUEFFELN","schnüffeln"),
		...
		Verb.verb("VERB_STROEMEN","strömen"),
		...
		Verb.verb("VERB_TRAEUMEN","träumen"),
		...
		Verb.verb("VERB_UEBERLEGEN","überlegen"),
		Verb.verb("VERB_UEBERMANNEN","übermannen"),
		Verb.verb("VERB_UEBERRASCHEN","überraschen"),
		Verb.verb("VERB_UEBERSCHLAGEN","überschlagen"),
		Verb.verb("VERB_UEBERSCHREIBEN","überschreiben"),
		Verb.verb("VERB_UEBERSTEHEN","überstehen"),
		Verb.verb("VERB_UEBERZIEHEN","überziehen"),
		...
		Verb.verb("VERB_VERDUENNEN","verdünnen"),
		...
		Verb.verb("VERB_VERFLUECHTIGEN","verflüchtigen"),
		Verb.verb("VERB_VERGEHEN","vergehen"),
		Verb.verb("VERB_VERHAERTEN","verhärten"),
		...
		Verb.verb("VERB_VERSCHUETTEN","verschütten"),
		...
		Verb.verb("VERB_VERSPUEREN","verspüren"),
		...
		Verb.verb("VERB_VERSTROEMEN","verströmen"),
		...
		Verb.verb("VERB_ZERSTOEREN","zerstören"),
...
def ausgabe_nouns
  ...
  [
    ...
    dekliniere_substantiv("NOUN_AXE", "Axt", "", "Äxt", "e", "feminin"),
    ...
    dekliniere_substantiv("NOUN_RUBBER_HOSE", "Gummiknüppel", "s", "Gummiknüppel", "", "maskulin"),
    ...
    dekliniere_nominalphrase("NOUN_DOUBLE_HEADED_AXE", "zweischneidig", "Doppelaxt", "", "Doppeläxt", "e", "feminin"),
    dekliniere_substantiv("NOUN_DOUBLE_HEADED_AXE", "Doppelaxt", "", "Doppeläxt", "e", "feminin"),
    ...
    dekliniere_substantiv("NOUN_THONGED_CLUB", "Riemenknüppel", "s", "Riemenknüppel", "", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_OILSKIN_CLOAK", "Ölzeug", "es", "Ölzeug", "e", "neutrum"), # Ölcape oder Regencape? js
    ...
    dekliniere_substantiv("NOUN_CLOAK_OF_DISPLACEMENT", "Umhang", "es", "Umhäng", "e", "maskulin", "s", "der Dislokation"), # Deplatzierung, Dislokation, Verdrängung, Verschiebung, Verrückung, Versatz, Verlagerung, Verwerfung, Verzerrung,
    ...
    dekliniere_nominalphrase("NOUN_SLIPPERY_CLOAK", "rutschig", "Umhang", "s", "Umhäng", "e", "maskulin"), # glibberig, schlüpfrig, rutschig, aalglatt, ölig
    ...
    dekliniere_substantiv("NOUN_WAND_STRIKING", "Kraftstoß", "es", "Kraftstöß", "e", "maskulin"), # js
    ...
    dekliniere_substantiv("NOUN_TIN_OPENER", "Büchsenöffner", "s", "Büchsenöffner", "", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_BUGBEAR", "Käferbär","en","Käferbär","en","maskulin", "en"),
    ...
    dekliniere_substantiv("NOUN_WATER_DEMON", "Wasserdämon", "s", "Wasserdämon", "en", "maskulin"), # Wasserteufel, Wasserdämon
    ...
    dekliniere_substantiv("NOUN_MAIL_DAEMON", "Briefdämon", "s", "Briefdämon", "en", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_CLOAK", "Umhang", "es", "Umhäng", "e", "maskulin", "s"),
    dekliniere_substantiv("NOUN_HELMET", "Helm", "es", "Helm", "e", "maskulin"),
    ...
    "/* Orte (role.c) */",
    dekliniere_nominalphrase("NOUN_GREAT_TEMPLE","Groß","Tempel","s","","","maskulin"),
    dekliniere_nominalphrase("NOUN_ARC_INSTITUT","Archäologisch","Institut","es","","e","neutrum"),
    dekliniere_substantiv("NOUN_TOMB","Grabstätte","","Grabstätte","en","feminin","n"),
    dekliniere_substantiv("NOUN_CAVE","Höhle","","Höhle","en","feminin","en"),
    dekliniere_substantiv("NOUN_CAVE_OF_THE_WUMPUS","Wumpushöhle","","Wumpushöhle","en","feminin","en"),
    ...
    dekliniere_substantiv("NOUN_FLUESSIGKEIT","Flüssigkeit","","","en","feminin"),
    ...
    dekliniere_substantiv("NOUN_AEQUATOR","Äquator","es","Äquator","en","maskulin"),
    dekliniere_substantiv("NOUN_AIR_CURRENT", "Luftströmung", "", "Luftströmung", "en", "feminin"),
    ...
    dekliniere_substantiv("NOUN_AUSRUESTUNG","Ausrüstung","","Ausrüstung","en","feminin"),
    ...
    dekliniere_substantiv("NOUN_BUCH","Buch","es","Büch","er","neutrum"),
    ...
    dekliniere_substantiv("NOUN_EISSTURM","Eissturm","es","Eisstürm","e","maskulin"),
    ...
    dekliniere_substantiv("NOUN_ENTSCHAEDIGUNG","Entschädigung","","Entschädigung","en","feminin"),
    ...
    dekliniere_substantiv("NOUN_FAEHIGKEIT","Fähigkeit","","Fähigkeit","en","feminin"),
    ...
    dekliniere_substantiv("NOUN_FLAESCHCHEN","Fläschchen","s","Fläschchen","","neutrum"),
    ...
    dekliniere_substantiv("NOUN_FLAMMENSAEULE","Flammensäule","","Flammensäule","en","feminin"),
    ...
    dekliniere_substantiv("NOUN_FLUEGEL","Flügel","s","Flügel","","maskulin"),
    dekliniere_substantiv("NOUN_FLUEGELSPITZE","Flügelspitze","","Flügelspitze","en","feminin"),
    dekliniere_substantiv("NOUN_FORTSATZ","Fortsatz","es","Fortsatz","e","maskulin"),
    dekliniere_substantiv("NOUN_FUEHLER","Fühler","s","Fühler","","maskulin"),
    ...
    dekliniere_substantiv("NOUN_GEAR","Zahnrad","es","Zahnräd","er","neutrum"),
    ...
    dekliniere_substantiv("NOUN_GRUND","Grund","es","Gründ","e","maskulin"),
    ...
    dekliniere_substantiv("NOUN_KRAFT","Kraft","","Kräft","e","feminin"),
    ...
    dekliniere_substantiv("NOUN_KRUG","Krug","es","Krüg","e","maskulin"),
    ...
    dekliniere_substantiv("NOUN_LAENGE","Länge","","Länge","en","feminin"),
    ...
    dekliniere_substantiv("NOUN_LAUF","Lauf","es","Läuf","e","maskulin"),
    ...
    dekliniere_substantiv("NOUN_OBERFLAECHE", "Oberfläche", "", "Oberfläche", "en", "feminin"), 
    dekliniere_substantiv("NOUN_OOZE", "Schlamm", "es", "Schlamm", "e", "maskulin"), 
    dekliniere_substantiv("NOUN_PACK","Rucksack","s","Rucksäck","e","maskulin"),
    ...
    dekliniere_substantiv("NOUN_PLATZ","Platz","es","Plätz","e","maskulin"),
    ...
    dekliniere_substantiv("NOUN_POOL","Tümpel","s","Tümpel","","maskulin"),
    dekliniere_substantiv("NOUN_POOL_OF_WATER","Wassertümpel","s","Wassertümpel","","maskulin"),
    ...
    dekliniere_substantiv("NOUN_RAND","Rand","es","Ränd","er","maskulin"),
    ...
    dekliniere_substantiv("NOUN_RUESSEL","Rüssel","s","Rüssel","","maskulin"),
    dekliniere_substantiv("NOUN_RUNE","Rune","","Rune","en","feminin"),
    dekliniere_substantiv("NOUN_SABER", "Säbel", "s", "Säbel", "", "maskulin"),
    dekliniere_substantiv("NOUN_SAEUREWOLKE","Säurewolke","","Säurewolke","en","feminin"),
    ...
    dekliniere_substantiv("NOUN_SCHNABEL","Schnabel","s","Schnäbel","","maskulin"),
    ...
    dekliniere_substantiv("NOUN_SOHN","Sohn","es","Söhn","e","maskulin"),
    ...
    dekliniere_substantiv("NOUN_STROEMUNG","Strömung","","Strömung","en","feminin"),
    ...
    dekliniere_substantiv("NOUN_TOCHTER","Tochter","","Töchter","","feminin"),
    ...
    dekliniere_substantiv("NOUN_TREPPENSTURZ","Treppensturz","es","Treppenstürz","e","maskulin"),
    dekliniere_substantiv("NOUN_TRIGGER","Auslösemechanismus","","Auslösemechanismen","fremder","maskulin"),
    dekliniere_substantiv("NOUN_TUMBLER","Gesperre","s","Gesperre","","neutrum"),
    dekliniere_substantiv("NOUN_UEBERANSTRENGUNG","Überanstrengung","","Überanstrengung","en","feminin"),
    ...
    dekliniere_substantiv("NOUN_ZAHN", "Zahn", "es", "Zähn", "e", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_ZUKUNFT","Zukunft","","Zukünft","e","feminin"),
    ...
    [unregelmaessiges_wort("NOUN_HALLU_UNIQUE_HERR_VON_BOEDEFELD", "Herr von Bödefeld", $nom, $mal, $sg)],
    [unregelmaessiges_wort("NOUN_HALLU_UNIQUE_HERR_VON_BOEDEFELD", "Herrn von Bödefelds", $gen, $mal, $sg)],
    [unregelmaessiges_wort("NOUN_HALLU_UNIQUE_HERR_VON_BOEDEFELD", "Herrn von Bödefeld", [$dat, $akk], $mal, $sg)],
    ...
    dekliniere_eigenname("NOUN_HALLU_UNIQUE_OETZI", "Ötzi", "maskulin"),
    dekliniere_eigenname("NOUN_HALLU_UNIQUE_GRENDEL", "Grendel", "maskulin"),
    dekliniere_eigenname("NOUN_HALLU_UNIQUE_RUEBEZAHL", "Rübezahl", "maskulin"),
    ...
    dekliniere_eigenname("NOUN_HALLU_UNIQUE_VAETERCHEN_FROST", "Väterchen Frost", "maskulin"),
    ...
    dekliniere_eigenname("NOUN_HALLU_UNIQUE_BEUTOLOMAEUS", "Beutolomäus", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_SCHLUMPF","Schlumpf", "s", "Schlümpf", "e", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_STAATSANWALT","Staatsanwalt", "s", "Staatsanwält", "e", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_RIESENPYGMAEE","Riesenpygmäe", "en", "Riesenpygmäe", "en", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_SCHWIEGERMUTTER","Schwiegermutter", "", "Schwiegermütt", "er", "feminin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_NIUF","Nagetier", "s", "Nagetier", "e", "neutrum", "", "in ungewöhnlichem Format"),
    ...
    dekliniere_substantiv("NOUN_HALLU_STOSSMICH_ZIEHDICH","Stoßmich-Ziehdich", "s", "Stoßmich-Ziehdich", "s", "neutrum"),
    dekliniere_nominalphrase("NOUN_HALLU_GEFRAESSIGER_PLAPPERKAEFER","Gefräßig", "Plapperkäfer", "s", "Plapperkäf", "er", "maskulin", "", "von Traal"),
    dekliniere_nominalphrase("NOUN_HALLU_HYDRA","siebenköpfig", "Hydra", "", "Hydra", "s", "feminin"),
    dekliniere_nominalphrase("NOUN_HALLU_WEISSES_KANINCHEN","weiß", "Kaninchen", "s", "Kaninchen", "", "neutrum"),
    ...
    dekliniere_substantiv("NOUN_HALLU_STEUERPRUEFER","Steuerprüfer", "s", "Steuerprüfer", "", "maskulin"),
    dekliniere_substantiv("NOUN_HALLU_GEZ_FAHNDER","GEZ-Fahnder", "s", "GEZ-Fahnder", "", "maskulin"),
    dekliniere_substantiv("NOUN_HALLU_GROSSINQUISITOR","Großinquisitor", "s", "Großinquisitor", "en", "maskulin"),
    dekliniere_substantiv("NOUN_HALLU_KLABAUTERMANN","Klabautermann", "s", "Klabautermänn", "er", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_SANDMANN","Sandmann", "s", "Sandmänn", "er", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_ERLKOENIG","Erlkönig", "s", "Erlkönig", "e", "maskulin"),
    dekliniere_substantiv("NOUN_HALLU_RAEUBER_HOTZENPLOTZ","Räuber", "s", "Räuber", "", "maskulin", "", "Hotzenplotz"),
    dekliniere_substantiv("NOUN_HALLU_SENSENMANN","Sensenmann", "s", "Sensenmänn", "er", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_SAEBELZAHNTIGER","Säbelzahntiger", "s", "Säbelzahntiger", "s", "maskulin"),
    dekliniere_substantiv("NOUN_HALLU_BIBABUTZEMANN","Bi-Ba-Butzemann", "s", "Bi-Ba-Butzemänn", "er", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_GRUEFFELO","Grüffelo", "s", "Grüffelo", "s", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_STEINLAUS","Steinlaus", "", "Steinläus", "e", "feminin"),
    dekliniere_substantiv("NOUN_HALLU_TRUHE","Truhe", "", "Truh", "en", "feminin"),
    dekliniere_substantiv("NOUN_HALLU_CHIMAERE","Chimäre", "", "Chimär", "en", "feminin"),
    ...
    dekliniere_substantiv("NOUN_HALLU_KARTOFFELPUE_REH","Kartoffelpü-Reh", "s", "Kartoffelpü-Reh", "e", "neutrum"),
    dekliniere_substantiv("NOUN_HALLU_MONDKALB","Mondkalb", "s", "Mondkälb", "er", "neutrum"),
    ...
    dekliniere_substantiv("NOUN_HALLU_KRUEMELMONSTER","Krümelmonster", "s", "Krümelmonster", "", "neutrum"),
    ...
    dekliniere_substantiv("NOUN_HALLU_MAINZELMAENNCHEN","Mainzelmännchen", "s", "Mainzelmännchen", "", "neutrum"),
    ...
    dekliniere_nominalphrase("NOUN_HALLU_WEISSER_HAI","weiß", "Hai", "s", "Hai", "e", "maskulin"),
    ...
    dekliniere_nominalphrase("NOUN_HALLU_SCHRUMPFHOERNIGER_SCHNARCHKACKLER","Schrumpfhörnig", "Schnarchkackler", "s", "Schnarchkackler", "", "maskulin"),
    ...
    dekliniere_nominalphrase("NOUN_HALLU_UNSICHTBARES_ROSA_EINHORN",["unsichtbar", "rosafarben"], "Einhorn", "s", "Einhörn", "er", "neutrum"),
    ...
    dekliniere_substantiv("NOUN_FARBE_GREEN", "Grün", "s", "Grün", "", "neutrum"),
    ...
    dekliniere_substantiv("NOUN_FARBE_CYAN", "Türkis", "s", "Türkis", "", "neutrum"),
    ...
    dekliniere_substantiv("NOUN_FARBE_BRIGHT_GREEN", "Knallgrün", "s", "Knallgrün", "", "neutrum"),
    ...
    dekliniere_substantiv("NOUN_FARBE_BRIGHT_CYAN", "Blaugrün", "s", "", "Blaugrün", "neutrum"),
    dekliniere_substantiv("NOUN_FARBE_WHITE", "Weiß", "s", "Weiß", "", "neutrum"),
    ...
    dekliniere_adjektiv("ADJEKTIV_FARBE_GEBLUEMT", "geblümt"),
    ...
    dekliniere_adjektiv("ADJEKTIV_FARBE_SUESS", "süß"),
    ...
    dekliniere_adjektiv("ADJEKTIV_CORRODEPROOF","korrosionsbeständig"),
    ...
    dekliniere_adjektiv("ADJEKTIV_FIXED","unverwüstlich"),
    dekliniere_adjektiv("ADJEKTIV_FIXED","imprägniert"),
    ...
    dekliniere_adjektiv("ADJEKTIV_ANFAENGLICH","anfänglich"),
    ...
    dekliniere_adjektiv("ADJEKTIV_DRACHENHAEUTIG", "drachenhäutig"),
    ...
    dekliniere_adjektiv("ADJEKTIV_ENTZUENDET", "entzündet"),
    dekliniere_adjektiv("ADJEKTIV_ERSPUERT", "erspürt"),
    ...
    dekliniere_adjektiv("ADJEKTIV_GENOZIDIOESE","genozidiös"),
    dekliniere_adjektiv("ADJEKTIV_GEOEFFNET","geöffnet"),
    dekliniere_adjektiv("ADJEKTIV_GERAEUCHERT","geräuchert"),
    dekliniere_adjektiv("ADJEKTIV_GERUCHLOS","geruchlos"),
    dekliniere_adjektiv("ADJEKTIV_GESAMT","gesamt"),
    dekliniere_adjektiv("ADJEKTIV_GESCHAETZT","geschätzt"),
    ...
    dekliniere_adjektiv("ADJEKTIV_KOENIGLICH", "königlich"),
    dekliniere_adjektiv("ADJEKTIV_KONTAMINIERT","kontaminiert"),
    dekliniere_adjektiv("ADJEKTIV_KRAEFTIGER","kräftiger"),
    ...
    dekliniere_adjektiv("ADJEKTIV_NATUERLICH","natürlich"),
    ...
    dekliniere_adjektiv("ADJEKTIV_PUERIERT","püriert"),
    ...
    dekliniere_adjektiv("ADJEKTIV_RENEGADE", "abtrünnig"),
    ...
    dekliniere_adjektiv("ADJEKTIV_SUESS_SAUER","süss-sauer"),
    dekliniere_adjektiv("ADJEKTIV_TOEDLICH","tödlich"),
    dekliniere_adjektiv("ADJEKTIV_UEBERBACKEN", "überbacken"),
    ...
    dekliniere_adjektiv("ADJEKTIV_UNGESCHUETZT", "ungeschützt"),
    ...
    dekliniere_adjektiv("ADJEKTIV_VERDUENNT","verdünnt"),
    ...
    dekliniere_adjektiv("ADJEKTIV_WELTBERUEHMT", "weltberühmt"),
