...
def ausgabe_nouns
  ...
  [
    ...
    [unregelmaessiges_wort("NOUN_HALLU_UNIQUE_BERND_DAS_BROT", "Bernds des Brots", $gen, $mal, $sg)],
    ...
    [unregelmaessiges_wort("NOUN_HALLU_UNIQUE_CHILI_DAS_SCHAF", "Chilis des Schafs", $gen, $mal, $sg)],
