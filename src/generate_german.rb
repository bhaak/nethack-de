...
def ausgabe_nouns
  ...
  [
    ...
    "",
    unregelmaessiges_wort("PRONOMEN_DIESER",  "keinem", $dat, [$mal,$neu], $sg),
    unregelmaessiges_wort("PRONOMEN_DIESER",  "keinen", $akk,  $mal,       $sg),
    unregelmaessiges_wort("PRONOMEN_DIESER",  "kein",   $akk,  $neu,       $sg),
    unregelmaessiges_wort("PRONOMEN_DIESER",  "keine",  [$nom,$akk], $fem, $sg),
    unregelmaessiges_wort("PRONOMEN_DIESER",  "keiner", [$gen,$dat], $fem, $sg),
    unregelmaessiges_wort("PRONOMEN_DIESER",  "keine",  [$nom,$akk], [$mal,$fem,$neu], $pl),
    unregelmaessiges_wort("PRONOMEN_DIESER",  "keiner",  $gen,       [$mal,$fem,$neu], $pl),
    unregelmaessiges_wort("PRONOMEN_DIESER",  "keinen",  $dat,       [$mal,$fem,$neu], $pl),
    "",
  ...
  [
    ...
    dekliniere_substantiv("NOUN_GLASS_ORB","Glasskugel","","Glasskugel","en","feminin"),
    ...
    dekliniere_substantiv("NOUN_PIERCER", "Bohrer", "s", "Bbohrer", "", "maskulin"),
    ...
    dekliniere_substantiv("NOUN_FOOT", "Fuß", "es", "Füß", "e", "feminin"),
    "",
    ...
    dekliniere_substantiv("NOUN_ALTAR","Altar","es","Altar","e","maskulin"),
    ...
    dekliniere_substantiv("NOUN_GESTALT","Gestalt","","Gestalt","en","feminin"),
		...
		dekliniere_substantiv("NOUN_SCHEPPERN","Scheppern","s","","","maskulin"),
