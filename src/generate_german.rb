...
def ausgabe_nouns
  ...
  [
    ...
    dekliniere_substantiv("NOUN_SINK", "Spülbecken", "s", "Spülbecken", "", "neutrum"),
    ...
    dekliniere_substantiv("NOUN_LAVA", "Klinge", "", "Klinge", "en", "feminin"),
    ...
    dekliniere_adjektiv("ADJEKTIV_BARE","bloßSUBJECT ARTIKEL_UNBESTIMMTER%s elektrischer NOUN_SHOCK VERB_SCHIESSEN OBJECT durch PRONOMEN_POSSESSIV NOUN_BODY!"),
