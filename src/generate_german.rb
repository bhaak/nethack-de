...
def ausgabe_nouns
  ...
  [
    ...
    dekliniere_substantiv("NOUN_GAUNTLETS_OF_FUMBLING", "Handschuh", "es", "Handschuh", "e", "maskulin", "", "der Tolpatschigkeit"), # Ungeschicklichkeit, Fummligkeit
    ...
    #dekliniere_substantiv("NOUN_WRAITH" # Todesalb, Schreckensalb
