...
boolean td;	/* td == TRUE : trap door or hole */
{
	...
	if(td) {
		...
		if (t->ttyp == TRAPDOOR)
			...
			pline("Unter KASUS_DATIV PRONOMEN_PERSONAL klafft ein riesengroßes Loch!"); /* EN pline("There's a gaping hole under you!"); */
	    }
	...
	if (dont_fall) {
		...
		pline("Das Loch unter KASUS_DATIV PRONOMEN_PERSONAL schließt sich wieder."); /* EN pline_The("opening under you closes up."); */
	    }
	    return;
	}
...
boolean disarm;
{
	...
	if (Luck > -13 && rn2(13+Luck) > 7) {	/* saved by luck */
		...
		case 10:
		case  9:  msg = "fließt die elektrische Ladung geerdet ab";  break; /* EN case  9:  msg = "electric charge is grounded";  break; */
		case  8:
