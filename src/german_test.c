...
START_TEST (test_german_the) {
	...
	check_german_the("NOUN_FROST_BRAND","Frostklinge");
	check_german_the("NOUN_FIRE_BRAND","Flammenklinge");
	...
	check_german_the("NOUN_VORPAL_BLADE","Vorpahlklinge");
	check_german_the("NOUN_SNICKERSNEE","Schnippelschnipp");
	check_german_the("NOUN_SUNSWORD","Sonnenschwert");
