...
START_TEST (test_german2meta) {
	char *text[][2] = {
		...
		{"ein verfluchter gläserner Zauberstab", "ARTIKEL_UNBESTIMMTER ADJEKTIV_CURSED ADJEKTIV_WAND_GLASS NOUN_WAND"},
...
START_TEST (test_german2meta2) {
	char *text[][2] = {
		...
		{"Schriftrolle der Rüstungszerstörung", "NOUN_SCROLL PARTIKEL_OF NOUN_SCR_DESTROY_ARMOR"},
...
START_TEST (test_german_the) {
	...
	check_german_the("NOUN_MJOLLNIR", "Mjöllnir");
	...
	check_german_the("NOUN_DRAGONBANE", "Drachentöter");
	check_german_the("NOUN_DEMONBANE", "Dämonentöter");
	check_german_the("NOUN_WEREBANE", "Wertöter");
	check_german_the("NOUN_GRAYSWANDIR", "Grayswandir");
	check_german_the("NOUN_GIANTSLAYER", "Riesenschlächter");
	check_german_the("NOUN_OGRESMASHER", "Ogermantscher");
	check_german_the("NOUN_TROLLSBANE", "Trolltöter");
	...
	check_german_the("NOUN_THE_ORB_OF_DETECTION", "die Kristallkugel der Enthüllung");
	...
	check_german_the("NOUN_THE_EYES_OF_THE_OVERWORLD", "das Auge der Überwelt");
	...
	check_german_the("NOUN_THE_MASTER_KEY_OF_THIEVERY", "der Generalschlüssel der Dieberei");
