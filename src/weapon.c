...
char *buf;
{
	...
	case P_BASIC:	     ptr = "Anfänger";     break; /* EN case P_BASIC:	     ptr = "Basic";     break; */
	...
	case P_GRAND_MASTER: ptr = "Großmeister"; break; /* EN case P_GRAND_MASTER: ptr = "Grand Master"; break; */
