...
ghost_from_bottle()
{
	...
	nomul(-3);
	nomovemsg = "SUBJECT PRONOMEN_PERSONAL VERB_GEWINNEN OBJECT PRONOMEN_PERSONAL NOUN_FASSUNG zur¸ck."; /* EN nomovemsg = "You regain your composure."; */
}
...
dodip()
{
	...
	poof:
		...
		if (obj->otyp == POT_WATER && !Hallucination) {
			pline_The("mixture bubbles%s.", /* EN pline_The("mixture bubbles%s.", */ // TODO DE die Mixtur, das Gebr‰u, das Gemisch, 
