...
drinkfountain()
{
	...
	if (mgkftn && u.uluck >= 0 && fate >= 10) {
		...
		pline("Wau!  %s großartig!", this_makes_you_feel); /* EN pline("Wow!  This makes you feel great!"); */
...
drinksink()
{
	...
	switch(rn2(20)) {
		...
		case 6: breaksink(u.ux,u.uy);
			break;
		case 7: pline("Das Wasser bewegt sich, als besäße es einen eigenen Willen!"); /* EN case 7: pline_The("water moves as though of its own will!"); */
